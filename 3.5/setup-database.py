...
def create_all_tables_mycodo():
    ...
    cur.execute("CREATE TABLE TSensorPreset (Preset TEXT, Name TEXT, Pin INT, Device TEXT, Period INT, Activated INT, Graph INT, Temp_Relay_High INT, Temp_Relay_Low INT, Temp_Set REAL, Temp_Set_Direction INT, Temp_Set_Buffer REAL, Temp_Period INT, Temp_P_High REAL, Temp_I_High REAL, Temp_D_High REAL, Temp_P_Low REAL, Temp_I_Low REAL, Temp_D_Low REAL)")
    ...
    cur.execute("CREATE TABLE HTSensorPreset (Preset TEXT, Name TEXT, Pin INT, Device TEXT, Period INT, Activated INT, Graph INT, Temp_Relay_High INT, Temp_Relay_Low INT, Temp_Set REAL, Temp_Set_Direction INT, Temp_Set_Buffer REAL, Temp_Period INT, Temp_P_High REAL, Temp_I_High REAL, Temp_D_High REAL, Temp_P_Low REAL, Temp_I_Low REAL, Temp_D_Low REAL, Hum_Relay_High INT, Hum_Relay_Low INT, Hum_Set REAL, Hum_Set_Direction INT, Hum_Set_Buffer REAL, Hum_Period INT, Hum_P_High REAL, Hum_I_High REAL, Hum_D_High REAL, Hum_P_Low REAL, Hum_I_Low REAL, Hum_D_Low REAL)")
    ...
    cur.execute("CREATE TABLE CO2SensorPreset (Preset TEXT, Name TEXT, Pin INT, Device TEXT, Period INT, Activated INT, Graph INT, CO2_Relay_High INT, CO2_Relay_Low INT, CO2_OR INT, CO2_Set REAL, CO2_Set_Direction INT, CO2_Set_Buffer REAL, CO2_Period INT, CO2_P_High REAL, CO2_I_High REAL, CO2_D_High REAL, CO2_P_Low REAL, CO2_I_Low REAL, CO2_D_Low REAL)")
