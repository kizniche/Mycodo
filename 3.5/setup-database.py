...
def create_all_tables_mycodo():
    ...
    # cur.execute("CREATE TABLE TSensor (Id INT, Name TEXT, Pin TEXT, Device TEXT, Period INT, Activated INT, Graph INT, Temp_Relay_High INT, Temp_Relay_Low INT, Temp_OR INT, Temp_Set REAL, Temp_Set_Direction INT, Temp_Period INT, Temp_P REAL, Temp_I REAL, Temp_D REAL)")
    ...
    cur.execute("CREATE TABLE CO2Sensor (Id INT, Name TEXT, Pin INT, Device TEXT, Period INT, Activated INT, Graph INT, CO2_Relay_High INT, CO2_Relay_Low INT, CO2_OR INT, CO2_Set REAL, CO2_Set_Direction INT, CO2_Period INT, CO2_P REAL, CO2_I REAL, CO2_D REAL)")
...
def create_rows_columns_mycodo():
    ...
    # for i in range(1, 5):
    #     cur.execute("INSERT INTO TSensor VALUES(%d, 'T-S%d', '0', 'DS18B20', 120, 0, 0, 0, 0, 1, 25.0, 0, 90, 0, 0, 0)" % (i, i))
    # for i in range(1, 5):
    ...
    # for i in range(1, 5):
    #     cur.execute("INSERT INTO CO2Sensor VALUES(%d, 'CO2-S%d', 0, 'K30', 120, 0, 0, 0, 0, 1, 2000, 0, 90, 0, 0, 0)" % (i, i))
    # for i in range(1, 9):
