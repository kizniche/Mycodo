...
while ($row = $results->fetchArray()) {
    ...
    $pid_t_temp_relay_high[$i] = $row[17];
    $pid_t_temp_outmax_high[$i] = $row[18];
    $pid_t_temp_relay_low[$i] = $row[19];
    $pid_t_temp_outmax_low[$i] = $row[20];
    $pid_t_temp_or[$i] = $row[21];
    $pid_t_temp_set[$i] = $row[22];
    $pid_t_temp_set_dir[$i] = $row[23];
    $pid_t_temp_period[$i] = $row[24];
    $pid_t_temp_p[$i] = $row[25];
    $pid_t_temp_i[$i] = $row[26];
    $pid_t_temp_d[$i] = $row[27];
    $i++;
}
...
while ($row = $results->fetchArray()) {
    ...
    $sensor_ht_yaxis_relay_min[$i] = $row[9];
    $sensor_ht_yaxis_relay_max[$i] = $row[10];
    $sensor_ht_yaxis_relay_tics[$i] = $row[11];
    $sensor_ht_yaxis_relay_mtics[$i] = $row[12];
    $sensor_ht_yaxis_temp_min[$i] = $row[13];
    $sensor_ht_yaxis_temp_max[$i] = $row[14];
    $sensor_ht_yaxis_temp_tics[$i] = $row[15];
    $sensor_ht_yaxis_temp_mtics[$i] = $row[16];
    $sensor_ht_yaxis_hum_min[$i] = $row[17];
    $sensor_ht_yaxis_hum_max[$i] = $row[18];
    $sensor_ht_yaxis_hum_tics[$i] = $row[19];
    $sensor_ht_yaxis_hum_mtics[$i] = $row[20];
    $pid_ht_temp_relay_high[$i] = $row[21];
    $pid_ht_temp_outmax_high[$i] = $row[22];
    $pid_ht_temp_relay_low[$i] = $row[23];
    $pid_ht_temp_outmax_low[$i] = $row[24];
    $pid_ht_temp_or[$i] = $row[25];
    $pid_ht_temp_set[$i] = $row[26];
    $pid_ht_temp_set_dir[$i] = $row[27];
    $pid_ht_temp_period[$i] = $row[28];
    $pid_ht_temp_p[$i] = $row[29];
    $pid_ht_temp_i[$i] = $row[30];
    $pid_ht_temp_d[$i] = $row[31];
    $pid_ht_hum_relay_high[$i] = $row[32];
    $pid_ht_hum_outmax_high[$i] = $row[33];
    $pid_ht_hum_relay_low[$i] = $row[34];
    $pid_ht_hum_outmax_low[$i] = $row[35];
    $pid_ht_hum_or[$i] = $row[36];
    $pid_ht_hum_set[$i] = $row[37];
    $pid_ht_hum_set_dir[$i] = $row[38];
    $pid_ht_hum_period[$i] = $row[39];
    $pid_ht_hum_p[$i] = $row[40];
    $pid_ht_hum_i[$i] = $row[41];
    $pid_ht_hum_d[$i] = $row[42];
    $i++;
}
...
while ($row = $results->fetchArray()) {
    ...
    $pid_co2_relay_high[$i] = $row[17];
    $pid_co2_outmax_high[$i] = $row[18];
    $pid_co2_relay_low[$i] = $row[19];
    $pid_co2_outmax_low[$i] = $row[20];
    $pid_co2_or[$i] = $row[21];
    $pid_co2_set[$i] = $row[22];
    $pid_co2_set_dir[$i] = $row[23];
    $pid_co2_period[$i] = $row[24];
    $pid_co2_p[$i] = $row[25];
    $pid_co2_i[$i] = $row[26];
    $pid_co2_d[$i] = $row[27];
    $i++;
...
while ($row = $results->fetchArray()) {
    ...
    $pid_press_temp_relay_high[$i] = $row[21];
    $pid_press_temp_outmax_high[$i] = $row[22];
    $pid_press_temp_relay_low[$i] = $row[23];
    $pid_press_temp_outmax_low[$i] = $row[24];
    $pid_press_temp_or[$i] = $row[25];
    $pid_press_temp_set[$i] = $row[26];
    $pid_press_temp_set_dir[$i] = $row[27];
    $pid_press_temp_period[$i] = $row[28];
    $pid_press_temp_p[$i] = $row[29];
    $pid_press_temp_i[$i] = $row[30];
    $pid_press_temp_d[$i] = $row[31];
    $pid_press_press_relay_high[$i] = $row[32];
    $pid_press_press_outmax_high[$i] = $row[33];
    $pid_press_press_relay_low[$i] = $row[34];
    $pid_press_press_outmax_low[$i] = $row[35];
    $pid_press_press_or[$i] = $row[36];
    $pid_press_press_set[$i] = $row[37];
    $pid_press_press_set_dir[$i] = $row[38];
    $pid_press_press_period[$i] = $row[39];
    $pid_press_press_p[$i] = $row[40];
    $pid_press_press_i[$i] = $row[41];
    $pid_press_press_d[$i] = $row[42];
    $i++;
}
