...
Also in this release is the disabling of opencv. I have yet to successfully implement a Python 3-compatible version of opencv that doesn't require an extremely long compiling process.
