These are the actions that can be added to Controllers (i.e. Conditional Controllers, Trigger Controllers) to provide a way to add additional functionality or interact with other parts of Mycodo.
