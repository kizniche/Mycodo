...
*   **[Functions](Functions.md)** that perform tasks, such as coupling Inputs and Outputs in interesting ways, such as [PID controllers](Functions.md/#pid-controller), [Conditional Controllers](Functions.md/#conditional), [Trigger Controllers](Functions.md/#trigger), to name a few (or create your own [Custom Functions](Functions.md/#custom-controllers)).
