...
class ImportInfluxdb(FlaskForm):
    ...
    influxdb_import_upload = SubmitField(lazy_gettext(u'Import Influxdb'))
...
class LogView(FlaskForm):
    ...
    loghttp_access = SubmitField(lazy_gettext(u'HTTP Access'))
    loghttp_error = SubmitField(lazy_gettext(u'HTTP Error'))
