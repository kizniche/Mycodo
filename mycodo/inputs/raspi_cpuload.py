...
class InputModule(AbstractInput):
    ...
    def get_measurement(self):
        ...
        if self.is_enabled('cpu_load_1m', 'cpu_load', 0):
            return_dict['battery']['cpu_load'][0] = load_avg[0]

        if self.is_enabled('cpu_load_5m', 'cpu_load', 0):
            return_dict['cpu_load_5m']['cpu_load'][0] = load_avg[1]

        if self.is_enabled('cpu_load_15m', 'cpu_load', 0):
            return_dict['cpu_load_15m']['cpu_load'][0] = load_avg[2]
