...
# Input information
INPUT_INFORMATION = {
    'unique_name_input': 'DS1822',
    'input_manufacturer': 'MAXIM',
    'common_name_input': 'DS1822',
...
class DS1822Sensor(AbstractInput):
    ...
    def __iter__(self):  # must return an iterator
        """ DS1822Sensor iterates through live temperature readings """
        return self
    ...
    def read(self):
        """
        Takes a reading from the DS1822 and updates the self._temperature value
