...
class InputModule(AbstractInput):
    ...
    def __init__(self, input_dev, testing=False):
        ...
        self.logger = logging.getLogger("mycodo.inputs.atlas_do")
        ...
        if not testing:
            self.logger = logging.getLogger(
                "mycodo.inputs.atlas_do_{id}".format(id=input_dev.unique_id.split('-')[0]))
    ...
    def initialize_sensor(self):
        ...
        if self.interface == 'FTDI':
            ...
            self.logger = logging.getLogger(
                "mycodo.inputs.atlas_do_ftdi_{ftdi}".format(
