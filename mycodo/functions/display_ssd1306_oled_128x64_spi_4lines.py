# coding=utf-8
#
#  display_ssd1306_oled_128x64_spi_4lines.py - Function to output to display
#
...
FUNCTION_INFORMATION = {
    'function_name_unique': 'display_ssd1306_oled_128x64_spi_4lines',
    'function_name': 'Display: SSD1306 OLED 128x64 [4 Lines] (SPI)',
    'function_library': 'Adafruit-Circuitpython-SSD1306',
    'execute_at_creation': execute_at_creation,
    'execute_at_modification': execute_at_modification,

    'message': 'This Function outputs to a 128x64 SSD1306 OLED display via SPI. This display Function will show 4 lines at a time, so channels are added in sets of 4 when Number of Line Sets is modified. Every Period, the LCD will refresh and display the next set of lines. Therefore, the first set of lines that are displayed are channels 0 - 3, then 4 - 7, and so on. After all channels have been displayed, it will cycle back to the beginning.',
