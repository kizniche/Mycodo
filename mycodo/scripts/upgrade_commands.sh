...
APT_PKGS="apache2 fswebcam gawk gcc git libapache2-mod-wsgi libav-tools libboost-python-dev libffi-dev libgtk2.0-0 libi2c-dev logrotate moreutils python3 python3-dev python3-numpy python-opencv python-setuptools python-smbus sqlite3 wget"
