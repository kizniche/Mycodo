...
#                                     (27, 60, 3400),
#                                     (30, 65, 3300)]
#         dht22 = DHT22Sensor(None, testing=True)
...
#     """  Verify that DHT22Sensor(None, testing=True).read() gets the average temp """
#     with mock.patch('mycodo.inputs.dht22.DHT22Sensor.get_measurement') as mock_measure:
#         mock_measure.side_effect = [(23, 50, 3000),
#                                     (25, 55, 3200)]
#         dht22 = DHT22Sensor(None, testing=True)
...
#             DHT22Sensor(None, testing=True).next()
#
#
...
#         assert DHT22Sensor(None, testing=True).read()
#
#
...
#             DHT22Sensor(None, testing=True).read()
