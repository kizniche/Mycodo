...
def test_ds18b20_iterates_using_in():
    ...
    with mock.patch('mycodo.inputs.ds18b20.InputModule.get_measurement') as mock_measure:
...
def test_ds18b20_special_method_repr():
    ...
    with mock.patch('mycodo.inputs.ds18b20.InputModule.get_measurement') as mock_measure:
        ...
        ds18b20 = DS18B20Sensor(None, testing=True)
        ds18b20.read()
        assert "<InputModule(temperature=0.00)>" in repr(ds18b20)


def test_ds18b20_raises_exception():
    """ stops iteration on read() error """
    with mock.patch('mycodo.inputs.ds18b20.InputModule.get_measurement', side_effect=IOError):
...
def test_ds18b20_read_returns_1_on_exception():
    ...
    with mock.patch('mycodo.inputs.ds18b20.InputModule.get_measurement', side_effect=Exception):
...
def test_ds18b20_read_logs_unknown_errors():
    ...
    with LogCapture() as log_cap:
        with mock.patch('mycodo.inputs.ds18b20.InputModule.get_measurement', side_effect=Exception('msg')):
            DS18B20Sensor(None, testing=True).read()
    expected_logs = ('mycodo.inputs.ds18b20', 'ERROR', 'InputModule raised an exception when taking a reading: msg')
