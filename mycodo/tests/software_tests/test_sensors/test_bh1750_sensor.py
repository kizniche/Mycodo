# coding=utf-8
""" Tests for the AtlasLux sensor class """
import mock
import pytest
from testfixtures import LogCapture

from collections import Iterator
from mycodo.sensors.bh1750 import BH1750Sensor
...
def test_bh1750_iterates_using_in():
    ...
    with mock.patch('mycodo.sensors.bh1750.BH1750Sensor.get_measurement') as mock_measure:
        mock_measure.side_effect = [67, 52, 37, 45]  # first reading, second reading

        bh1750 = BH1750Sensor(1, 1, 1, 1, testing=True)
...
def test_bh1750_raises_exception():
    ...
    with mock.patch('mycodo.sensors.bh1750.BH1750Sensor.get_measurement', side_effect=IOError):
        with pytest.raises(StopIteration):
            BH1750Sensor(1, 1, 1, 1, testing=True).next()


def test_bh1750_read_returns_1_on_exception():
    """ Verify the read() method returns true on error """
    with mock.patch('mycodo.sensors.bh1750.BH1750Sensor.get_measurement', side_effect=Exception):
        assert BH1750Sensor(1, 1, 1, 1, testing=True).read()
...
def test_bh1750_read_logs_unknown_errors():
    ...
    with LogCapture() as log_cap:
        ...
        with mock.patch('mycodo.sensors.bh1750.BH1750Sensor.get_measurement', side_effect=Exception('msg')):
            BH1750Sensor(1, 1, 1, 1, testing=True).read()
    expected_logs = ('mycodo.sensors.bh1750', 'ERROR', 'BH1750Sensor raised an exception when taking a reading: msg')
