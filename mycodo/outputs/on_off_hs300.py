...
OUTPUT_INFORMATION = {
    ...
    'output_name': f"{lazy_gettext('On/Off')}: HS300 Kasa Smart WiFi Power Strip",
    ...
    'message': 'This output controls the 6 outlets of the Kasa HS300 Smart WiFi Power Strip.',
